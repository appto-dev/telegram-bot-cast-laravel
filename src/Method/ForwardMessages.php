 ...
 */
class ForwardMessages extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  int|null  Identifier of the direct messages topic to which the messages will be forwarded;
        ...
        /** @var  bool|null  Protects the contents of the forwarded messages from forwarding and saving */
