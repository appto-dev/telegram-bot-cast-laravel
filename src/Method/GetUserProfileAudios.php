 ...
 */
class GetUserProfileAudios extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  int  Unique identifier of the target user */
        public int $user_id,
        /**
         * @var  int|null  Sequential number of the first audio to be returned. By default, all audios are
         * returned.
         */
        public ?int $offset,
        /**
         * @var  int|null  Limits the number of audios to be retrieved. Values between 1-100 are accepted.
         * Defaults to 100.
         */
        public ?int $limit,
    ) {
