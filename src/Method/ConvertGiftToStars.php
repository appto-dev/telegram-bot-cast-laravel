 ...
 */
class ConvertGiftToStars extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  string  Unique identifier of the business connection */
        public string $business_connection_id,
        /** @var  string  Unique identifier of the regular gift that should be converted to Telegram Stars */
