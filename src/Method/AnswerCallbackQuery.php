 ...
 *
 * Alternatively, the
 * user can be redirected to the specified Game URL. For this option to work, you
 * must first create a game for your bot via @BotFather and accept the terms.
 ...
 */
final class AnswerCallbackQuery extends Data implements MethodInterface
{
