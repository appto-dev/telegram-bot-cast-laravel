 ...
 */
class SendAudio extends Data implements TelegramMethod
{
    public function __construct(
         ...
         * audio file from the Internet, or upload a new one using multipart/form-data.
         * <a href="#sending-files">More information on Sending Files </a>
         */
        public InputFile|string $audio,
        /** @var  string|null  Audio caption, 0-1024 characters after entities parsing */
        public ?string $caption,
        /**
         * @var  string|null  Mode for parsing entities in the audio caption. See
