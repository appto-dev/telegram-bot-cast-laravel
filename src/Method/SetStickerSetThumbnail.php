...
final class SetStickerSetThumbnail extends Data implements TelegramMethodInterface
{
    public function __construct(
         ...
         * </a>. Animated and video sticker set thumbnails can't be uploaded via HTTP URL.
         * If omitted, then the thumbnail is dropped and the first sticker is used as the
         * thumbnail.
