 ...
 */
class SetStickerSetThumbnail extends Data implements TelegramMethod
{
    public function __construct(
        ...
        public int $user_id,
        /**
         * @var  InputFile|string|null  A <strong>.WEBP</strong> or <strong>.PNG</strong> image with the
         * thumbnail, must be up to 128 kilobytes in size and have a width and height of exactly 100px, or a
         * <strong>.TGS</strong> animation with a thumbnail up to 32 kilobytes in size (see
        ...
        /**
         * @var  string  Format of the thumbnail, must be one of "static" for a <strong>.WEBP</strong> or
         * <strong>.PNG</strong> image, "animated" for a <strong>.TGS</strong> animation, or "video" for a
