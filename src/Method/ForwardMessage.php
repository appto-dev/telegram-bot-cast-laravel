 ...
 */
class ForwardMessage extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  int|null  Identifier of the direct messages topic to which the message will be forwarded;
        ...
        /** @var  int|null  New start timestamp for the forwarded video in the message */
        ...
        /** @var  bool|null  Protects the contents of the forwarded message from forwarding and saving */
