 ...
 */
class SetChatAdministratorCustomTitle extends Data implements TelegramMethod
{
    public function __construct(
        ...
        public int $user_id,
        /** @var  string  New custom title for the administrator; 0-16 characters, emoji are not allowed */
