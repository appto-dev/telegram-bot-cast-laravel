 ...
 */
class GetChatAdministrators extends Data implements TelegramMethod
{
    public function __construct(
        /**
         * @var  int|string  Unique identifier for the target chat or username of the target supergroup or
         * channel in the format <code>@username</code>
         */
        public int|string $chat_id,
        /**
         * @var  bool|null  Pass <em>True</em> to additionally receive all bots that are administrators of the
