 ...
 */
class SetUserEmojiStatus extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  int  Unique identifier of the target user */
        public int $user_id,
        /**
         * @var  string|null  Custom emoji identifier of the emoji status to set. Pass an empty string to
         * remove the status.
         */
        public ?string $emoji_status_custom_emoji_id,
        /** @var  int|null  Expiration date of the emoji status, if any */
