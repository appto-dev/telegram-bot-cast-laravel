 ...
 */
class GetChatGifts extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  bool|null  Pass <em>True</em> to exclude gifts that aren't saved to the chat's profile page.
         * Always <em>True</em>, unless the bot has the <em>can_post_messages</em> administrator right in the
         * channel.
         */
        public ?bool $exclude_unsaved,
        /**
         * @var  bool|null  Pass <em>True</em> to exclude gifts that are saved to the chat's profile page.
         * Always <em>False</em>, unless the bot has the <em>can_post_messages</em> administrator right in the
         * channel.
         */
