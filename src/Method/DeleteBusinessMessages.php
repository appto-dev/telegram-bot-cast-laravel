 ...
 */
class DeleteBusinessMessages extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  string  Unique identifier of the business connection on behalf of which to delete the messages */
        public string $business_connection_id,
        /**
         * @var  int[]  A JSON-serialized list of 1-100 identifiers of messages to delete. All messages must be
         * from the same chat. See <a href="#deletemessage">deleteMessage</a> for limitations on which messages
         * can be deleted.
         */
