 ...
 */
class CopyMessage extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  int|string  Unique identifier for the chat where the original message was sent (or username of
         * the target bot, supergroup or channel in the format <code>@username</code>)
         */
        public int|string $from_chat_id,
        /** @var  int  Message identifier in the chat specified in <em>from_chat_id</em> */
        public int $message_id,
        /** @var  int|null  New start timestamp for the copied video in the message */
        public ?int $video_start_timestamp,
        /**
         * @var  string|null  New caption for media, 0-1024 characters after entities parsing. If not
         * specified, the original caption is kept.
         */
        public ?string $caption,
        /**
         * @var  string|null  Mode for parsing entities in the new caption. See
         * <a href="#formatting-options">formatting options</a> for more details.
         */
        public ?string $parse_mode,
        /**
         * @var  MessageEntity[]|null  A JSON-serialized list of special entities that appear in the new
         * caption, which can be specified instead of <em>parse_mode</em>
         */
        public ?array $caption_entities,
        /**
         * @var  bool|null  Pass <em>True</em> if the caption must be shown above the message media. Ignored if
        ...
        /**
         * @var  string|null  Unique identifier of the message effect to be added to the message; only
