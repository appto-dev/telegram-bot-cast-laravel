 ...
 */
class GetBusinessAccountGifts extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  string  Unique identifier of the business connection */
        public string $business_connection_id,
        /** @var  bool|null  Pass <em>True</em> to exclude gifts that aren't saved to the account's profile page */
        public ?bool $exclude_unsaved,
        /** @var  bool|null  Pass <em>True</em> to exclude gifts that are saved to the account's profile page */
        ...
        /**
         * @var  string|null  Offset of the first entry to return as received from the previous request; use
