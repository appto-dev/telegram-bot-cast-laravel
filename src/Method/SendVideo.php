 ...
 */
class SendVideo extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  InputFile|string  Video to send. Pass a file_id as String to send a video that exists on the
         * Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a video from the
        ...
        /**
         * @var  InputFile|string|null  Cover for the video in the message. Pass a file_id to send a file that
         * exists on the Telegram servers (recommended), pass an HTTP URL for Telegram to get a file from the
         * Internet, or pass "attach://<file_attach_name>" to upload a new one using multipart/form-data under
         * <file_attach_name> name. <a href="#sending-files">More information on Sending Files </a>
         */
        public InputFile|string|null $cover,
        /** @var  int|null  Start timestamp for the video in the message */
        public ?int $start_timestamp,
        /**
         * @var  string|null  Video caption (may also be used when resending videos by <em>file_id</em>),
         * 0-1024 characters after entities parsing
         */
        public ?string $caption,
        /**
         * @var  string|null  Mode for parsing entities in the video caption. See
        ...
        /** @var  bool|null  Pass <em>True</em> if the caption must be shown above the message media */
        public ?bool $show_caption_above_media,
        /** @var  bool|null  Pass <em>True</em> if the video needs to be covered with a spoiler animation */
        public ?bool $has_spoiler,
        /** @var  bool|null  Pass <em>True</em> if the uploaded video is suitable for streaming */
