 ...
 */
class DeleteAllMessageReactions extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  int|null  Identifier of the user whose reactions will be removed, if the reactions were added
         * by a user
         */
        public ?int $user_id,
        /**
         * @var  int|null  Identifier of the chat whose reactions will be removed, if the reactions were added
         * by a chat
         */
