 ...
 */
class SendLivePhoto extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  InputFile|string  Live photo video to send. The video must be no longer than 10 seconds and
         * must not exceed 10 MB in size. Pass a file_id as String to send a video that exists on the Telegram
         ...
         */
        public InputFile|string $live_photo,
        /**
         * @var  InputFile|string  The static photo to send. Pass a file_id as String to send a photo that
