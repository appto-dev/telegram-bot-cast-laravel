 ...
 */
class SendPhoto extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  InputFile|string  Photo to send. Pass a file_id as String to send a photo that exists on the
         * Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a photo from the
         * Internet, or upload a new photo using multipart/form-data. The photo must be at most 10 MB in size.
         * The photo's width and height must not exceed 10000 in total. Width and height ratio must be at most
         * 20. <a href="#sending-files">More information on Sending Files </a>
         */
        public InputFile|string $photo,
        /**
         * @var  string|null  Photo caption (may also be used when resending photos by <em>file_id</em>),
         * 0-1024 characters after entities parsing
         */
        public ?string $caption,
        /**
         * @var  string|null  Mode for parsing entities in the photo caption. See
        ...
        /** @var  bool|null  Pass <em>True</em> if the photo needs to be covered with a spoiler animation */
