 ...
 */
class SendDice extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  string|null  Emoji on which the dice throw animation is based. Currently, must be one of
        ...
        /** @var  bool|null  Protects the contents of the sent message from forwarding */
