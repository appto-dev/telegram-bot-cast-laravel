 ...
 */
class SendAnimation extends Data implements TelegramMethod
{
    public function __construct(
        ...
        /**
         * @var  InputFile|string  Animation to send. Pass a file_id as String to send an animation that exists
        ...
        /** @var  int|null  Duration of sent animation in seconds */
        public ?int $duration,
        ...
        /**
         * @var  string|null  Animation caption (may also be used when resending animation by
         * <em>file_id</em>), 0-1024 characters after entities parsing
         */
        public ?string $caption,
        /**
         * @var  string|null  Mode for parsing entities in the animation caption. See
        ...
        /** @var  bool|null  Pass <em>True</em> if the animation needs to be covered with a spoiler animation */
