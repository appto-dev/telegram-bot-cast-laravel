 ...
 */
class GetManagedBotAccessSettings extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  int  User identifier of the managed bot whose access settings will be returned */
        public int $user_id,
    ) {
    }
}
