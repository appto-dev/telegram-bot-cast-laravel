 ...
 */
class DeclineSuggestedPost extends Data implements TelegramMethod
{
    public function __construct(
        /** @var  int  Unique identifier for the target direct messages chat */
        public int $chat_id,
        /** @var  int  Identifier of a suggested post message to decline */
        public int $message_id,
        /** @var  string|null  Comment for the creator of the suggested post; 0-128 characters */
