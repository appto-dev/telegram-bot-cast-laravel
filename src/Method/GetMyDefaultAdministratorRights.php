 ...
 */
class GetMyDefaultAdministratorRights extends Data implements TelegramMethod
{
    public function __construct(
        /**
         * @var  bool|null  Pass <em>True</em> to get default administrator rights of the bot in channels.
