 ...
 */
class Audio extends Data implements TelegramType
{
    public function __construct(
        ...
        public int $duration,
        /** @var  string|null  Performer of the audio as defined by the sender or by audio tags */
        public ?string $performer,
        /** @var  string|null  Title of the audio as defined by the sender or by audio tags */
        public ?string $title,
