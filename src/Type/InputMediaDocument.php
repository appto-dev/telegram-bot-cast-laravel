 ...
 */
class InputMediaDocument extends Data implements TelegramType, InputPollMedia, InputMedia
{
    public function __construct(
        /** @var  string  Type of the media, must be document */
        public string $type,
        /**
        ...
        /**
         * @var  string|null  Mode for parsing entities in the document caption. See formatting options for
         * more details.
         */
