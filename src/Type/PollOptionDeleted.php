 ...
 */
class PollOptionDeleted extends Data implements TelegramType
{
    public function __construct(
        /**
         * @var  MaybeInaccessibleMessage|null  Message containing the poll from which the option was deleted,
         * if known. Note that the Message object in this field will not contain the reply_to_message field
         * even if it itself is a reply.
         */
        #[WithCast(MaybeInaccessibleMessageCast::class)]
        public ?MaybeInaccessibleMessage $poll_message,
        /** @var  string  Unique identifier of the deleted option */
