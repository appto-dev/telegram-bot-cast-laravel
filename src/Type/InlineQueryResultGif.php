 ...
 */
class InlineQueryResultGif extends Data implements TelegramType, InlineQueryResult
{
    public function __construct(
        ...
        /** @var  int|null  Duration of the GIF in seconds */
        public ?int $gif_duration,
        /** @var  string  URL of the static (JPEG or GIF) or animated (MPEG4) thumbnail for the result */
        public string $thumbnail_url,
        /**
         * @var  string|null  MIME type of the thumbnail, must be one of "image/jpeg", "image/gif", or
        ...
        /**
         * @var  string|null  Mode for parsing entities in the caption. See formatting options for more
         * details.
         */
