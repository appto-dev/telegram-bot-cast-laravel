 ...
 * "underline", "strikethrough", "spoiler", "blockquote" and "custom_emoji"
 * entities, use parse mode MarkdownV2 instead.
 *  - To escape characters '_', '*',
 * '`', '[' outside of an entity, prepend the characters '\' before them.
 *  -
 * Escaping inside entities is not allowed, so entity must be closed first and
 * reopened again: use _snake_\__case_ for italic snake_case and *2*\**2=4* for
 * bold 2*2=4.
 *
 ...
 */
final class FormattingOptions extends Data implements TypeInterface
{
}
