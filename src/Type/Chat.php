 ...
 */
final class Chat extends Data implements TypeInterface
{
    public function __construct(
         ...
         * profile accent colors for more details. Returned only in getChat.
         */
