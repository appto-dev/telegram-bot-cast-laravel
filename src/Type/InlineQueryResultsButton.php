 ...
 */
final class InlineQueryResultsButton extends Data implements TelegramTypeContract
{
    public function __construct(
         ...
         * connect the bot to their YouTube account to adapt search results accordingly. To
         * do this, it displays a 'Connect your YouTube account' button above the results,
         * or even before showing any. The user presses the button, switches to a private
         * chat with the bot and, in doing so, passes a start parameter that instructs the
