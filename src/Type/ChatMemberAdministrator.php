 ...
 */
class ChatMemberAdministrator extends Data implements TelegramType, ChatMember
{
    public function __construct(
        ...
        /**
         * @var  bool  True, if the administrator can access the chat event log, get boost list, see hidden
        ...
        /**
         * @var  bool  True, if the administrator can restrict, ban or unban chat members, or access supergroup
         * statistics
         */
        public bool $can_restrict_members,
        /**
         * @var  bool  True, if the administrator can add new administrators with a subset of their own
        ...
        /**
         * @var  bool  True, if the administrator can edit stories posted by other users, post stories to the
        ...
        /**
         * @var  bool|null  True, if the administrator can post messages in the channel, approve suggested
         * posts, or access channel statistics; for channels only
         */
        public ?bool $can_post_messages,
        /**
         * @var  bool|null  True, if the administrator can edit messages of other users and can pin messages;
         * for channels only
         */
        public ?bool $can_edit_messages,
        /** @var  bool|null  True, if the user is allowed to pin messages; for groups and supergroups only */
        public ?bool $can_pin_messages,
        /**
         * @var  bool|null  True, if the user is allowed to create, rename, close, and reopen forum topics; for
         * supergroups only
         */
        public ?bool $can_manage_topics,
        /**
         * @var  bool|null  True, if the administrator can manage direct messages of the channel and decline
