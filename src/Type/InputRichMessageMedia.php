...
class InputRichMessageMedia extends Data implements TelegramType
{
    public function __construct(
        /**
         * @var  string  Unique identifier of the media used in a tg://photo?id=, tg://video?id=,
         * tg://document?id=, or tg://audio?id= link. 1-64 characters, only A-Z, a-z, 0-9, _ and - are allowed.
         */
        public string $id,
        /**
         * @var
