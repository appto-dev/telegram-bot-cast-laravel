 ...
 */
class VideoQuality extends Data implements TelegramType
{
    public function __construct(
        ...
        /** @var  int  Video width */
        public int $width,
        /** @var  int  Video height */
        public int $height,
        /** @var  string  Codec that was used to encode the video, for example, "h264", "h265", or "av01" */
        public string $codec,
        /**
