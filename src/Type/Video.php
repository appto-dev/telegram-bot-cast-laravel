 ...
 */
class Video extends Data implements TelegramType
{
    public function __construct(
        ...
        /** @var  PhotoSize[]|null  Available sizes of the cover of the video in the message */
        public ?array $cover,
        /** @var  int|null  Timestamp in seconds from which the video will play in the message */
        public ?int $start_timestamp,
        /** @var  VideoQuality[]|null  List of available qualities of the video */
        public ?array $qualities,
        /** @var  string|null  Original filename as defined by the sender */
