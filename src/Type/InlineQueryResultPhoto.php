 ...
 */
class InlineQueryResultPhoto extends Data implements TelegramType, InlineQueryResult
{
    public function __construct(
        ...
        public string $id,
        /**
         * @var  string  A valid URL of the photo. Photo must be in JPEG format. Photo size must not exceed
         * 5MB.
         */
