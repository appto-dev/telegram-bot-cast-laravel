 ...
 */
class RichTextBankCardNumber extends Data implements TelegramType, RichText
{
    public function __construct(
        /** @var  string  Type of the rich text, always "bank_card_number" */
        public string $type,
        /** @var  RichText  The text */
        #[WithCast(RichTextCast::class)]
        public RichText $text,
        /** @var  string  The bank card number */
