 ...
 */
class InputProfilePhotoAnimated extends Data implements TelegramType, InputProfilePhoto
{
    public function __construct(
        /** @var  string  Type of the profile photo, must be animated */
        public string $type,
        /**
         * @var  InputFile|string  The animated profile photo. Profile photos can't be reused and can only be
        ...
        /**
         * @var  float|null  Timestamp in seconds of the frame that will be used as the static profile photo.
         * Defaults to 0.0.
         */
