 ...
 */
class InputMediaVideo extends Data implements TelegramType, InputPollMedia, InputPollOptionMedia, InputMedia
{
    public function __construct(
        ...
        /** @var  bool|null  Pass True if the video needs to be covered with a spoiler animation */
