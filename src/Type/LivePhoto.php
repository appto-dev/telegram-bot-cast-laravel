 ...
 */
class LivePhoto extends Data implements TelegramType
{
    public function __construct(
        /** @var  PhotoSize[]|null  Available sizes of the corresponding static photo */
        public ?array $photo,
        /** @var  string  Identifier for the video file which can be used to download or reuse the file */
        public string $file_id,
        /**
         * @var  string  Unique identifier for the video file which is supposed to be the same over time and
