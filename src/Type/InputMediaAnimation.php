 ...
 */
class InputMediaAnimation extends Data implements TelegramType, InputPollMedia, InputPollOptionMedia, InputMedia
{
    public function __construct(
        /** @var  string  Type of the media, must be animation */
        public string $type,
        /**
        ...
        /**
         * @var  string|null  Mode for parsing entities in the animation caption. See formatting options for
         * more details.
         */
        ...
        public ?int $height,
        /** @var  int|null  Animation duration in seconds */
        public ?int $duration,
        /** @var  bool|null  Pass True if the animation needs to be covered with a spoiler animation */
