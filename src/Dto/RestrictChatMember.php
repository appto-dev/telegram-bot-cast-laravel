...
final class RestrictChatMember extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Date when restrictions will be lifted for the user; Unix time. If user is restricted for more than 366 days or less than
         * 30 seconds from the current time, they are considered to be restricted forever
         */
