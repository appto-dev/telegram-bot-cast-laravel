...
final class GetChatGifts extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Pass <em>True</em> to exclude gifts that aren't saved to the chat's profile page. Always <em>True</em>, unless the bot
         * has the <em>can_post_messages</em> administrator right in the channel.
         */
        public ?bool $exclude_unsaved,
        /**
         * Pass <em>True</em> to exclude gifts that are saved to the chat's profile page. Always <em>False</em>, unless the bot has
         * the <em>can_post_messages</em> administrator right in the channel.
         */
        ...
        /**
         * Offset of the first entry to return as received from the previous request; use an empty string to get the first chunk of
         * results
         */
