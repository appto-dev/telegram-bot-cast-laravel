...
final class GetChatGifts extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * the bot has the <em>can_post_messages</em> administrator right in the channel.
         */
        public ?bool $exclude_unsaved,
        /**
         * Pass <em>True</em> to exclude gifts that are saved to the chat's profile page. Always <em>False</em>, unless
         * the bot has the <em>can_post_messages</em> administrator right in the channel.
         */
        ...
        /**
         * Pass <em>True</em> to exclude gifts that can be purchased a limited number of times and can be upgraded to
         * unique
         */
        public ?bool $exclude_limited_upgradable,
        /**
         * Pass <em>True</em> to exclude gifts that can be purchased a limited number of times and can't be upgraded to
         * unique
         */
        public ?bool $exclude_limited_non_upgradable,
        /**
         * Pass <em>True</em> to exclude gifts that were assigned from the TON blockchain and can't be resold or
