 ...
 */
final class SendLivePhoto extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Live photo video to send. The video must be no longer than 10 seconds and must not exceed 10 MB in size. Pass
         * a file_id as String to send a video that exists on the Telegram servers (recommended) or upload a new video
         * using multipart/form-data. <a href="#sending-files">More information on Sending Files </a>. Sending live
         ...
         * Sending Files </a>. Sending live photos by a URL is currently unsupported.
         */
        public InputFile|string $photo,
        /**
         * Video caption (may also be used when resending videos by <em>file_id</em>), 0-1024 characters after entities
         * parsing
         */
        public ?string $caption,
        /**
         * Mode for parsing entities in the video caption. See <a href="#formatting-options">formatting options</a> for
         * more details.
         */
