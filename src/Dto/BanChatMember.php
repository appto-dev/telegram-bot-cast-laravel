...
final class BanChatMember extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Pass <em>True</em> to delete all messages from the chat for the user that is being removed. If <em>False</em>, the user
         * will be able to see messages in the group that were sent before the user was removed. Always <em>True</em> for
