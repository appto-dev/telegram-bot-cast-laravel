...
final class GetUpdates extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * returned. An update is considered confirmed as soon as <a href="#getupdates">getUpdates</a> is called with an
         * <em>offset</em> higher than its <em>update_id</em>. The negative offset can be specified to retrieve updates
         * starting from <em>-offset</em> update from the end of the updates queue. All previous updates will be
         * forgotten.
         */
        public ?int $offset,
