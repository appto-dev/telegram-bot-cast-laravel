...
final class GetUpdates extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * considered confirmed as soon as <a
         * href="https://core.telegram.org/bots/api#getupdates">getUpdates</a> is called
         ...
         * setting will be used.<br><br>Please note that this parameter doesn't affect
         * updates created before the call to getUpdates, so unwanted updates may be
