...
final class SendSticker extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Sticker to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP
         * URL as a String for Telegram to get a .WEBP sticker from the Internet, or upload a new .WEBP, .TGS, or .WEBM sticker
         * using multipart/form-data. <a href="#sending-files">More information on Sending Files </a>. Video and animated stickers
