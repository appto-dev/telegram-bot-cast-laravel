...
final class AnswerPreCheckoutQuery extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Specify <em>True</em> if everything is alright (goods are available, etc.) and the bot is ready to proceed
         * with the order. Use <em>False</em> if there are any problems.
         */
        public bool $ok,
        /**
         * Required if <em>ok</em> is <em>False</em>. Error message in human readable form that explains the reason for
         * failure to proceed with the checkout (e.g. "Sorry, somebody just bought the last of our amazing black T-shirts
         * while you were busy filling out your payment details. Please choose a different color or garment!"). Telegram
