...
final class SendInvoice extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * A JSON-serialized object for an <a href="/bots/features#inline-keyboards">inline keyboard</a>. If empty, one
         * 'Pay <code>total price</code>' button will be shown. If not empty, the first button must be a Pay button.
         */
