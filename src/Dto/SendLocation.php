...
final class SendLocation extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Period in seconds during which the location will be updated (see <a href="https://telegram.org/blog/live-locations">Live
         * Locations</a>, should be between 60 and 86400, or 0x7FFFFFFF for live locations that can be edited indefinitely.
         */
