...
final class RemoveBusinessAccountProfilePhoto extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Pass <em>True</em> to remove the public photo, which is visible even if the main photo is hidden by the business
         * account's privacy settings. After the main photo is removed, the previous profile photo (if present) becomes the main
         * photo.
         */
