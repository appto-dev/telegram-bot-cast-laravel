...
final class ApproveSuggestedPost extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Point in time (Unix timestamp) when the post is expected to be published; omit if the date has already been specified
         * when the suggested post was created. If specified, then the date must be not more than 2678400 seconds (30 days) in the
         * future
         */
