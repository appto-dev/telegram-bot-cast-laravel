...
final class ForwardMessages extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Identifier of the direct messages topic to which the messages will be forwarded; required if the messages are forwarded
        ...
        /**
         * A JSON-serialized list of 1-100 identifiers of messages in the chat <em>from_chat_id</em> to forward. The identifiers
         * must be specified in a strictly increasing order.
         * @var array<int>
         */
        public array $message_ids,
        /**
         * Sends the messages <a href="https://telegram.org/blog/channels-2-0#silent-messages">silently</a>. Users will receive a
