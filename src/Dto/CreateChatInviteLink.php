 ...
 */
final class CreateChatInviteLink extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * <em>True</em>, if users joining the chat via the link need to be approved by chat administrators. If <em>True</em>,
