 ...
 */
final class SendVideo extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * URL as a String for Telegram to get a video from the Internet, or upload a new video using multipart/form-data. <a
         ...
         * using multipart/form-data under <file_attach_name> name. <a href="#sending-files">More information on Sending Files </a>
         */
        ...
        /**
         * Mode for parsing entities in the video caption. See <a href="#formatting-options">formatting options</a> for more
         * details.
         */
