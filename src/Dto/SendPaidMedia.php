...
final class SendPaidMedia extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * <code>@username</code>. If the chat is a channel, all Telegram Star proceeds from this media will be credited
        ...
        /**
         * Mode for parsing entities in the media caption. See <a href="#formatting-options">formatting options</a> for
         * more details.
         */
