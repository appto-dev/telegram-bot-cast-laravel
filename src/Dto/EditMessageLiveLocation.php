...
final class EditMessageLiveLocation extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * 0x7FFFFFFF is specified, then the location can be updated forever. Otherwise, the new value must not exceed
         * the current <em>live_period</em> by more than a day, and the live location expiration date must remain within
         * the next 90 days. If not specified, then <em>live_period</em> remains unchanged
         */
