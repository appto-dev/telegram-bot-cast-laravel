 ...
 */
final class SendAudio extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Mode for parsing entities in the audio caption. See <a href="#formatting-options">formatting options</a> for more
         * details.
         */
