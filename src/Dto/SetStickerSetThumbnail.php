...
final class SetStickerSetThumbnail extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        public int $user_id,
        /**
         * A <strong>.WEBP</strong> or <strong>.PNG</strong> image with the thumbnail, must
         * be up to 128 kilobytes in size and have a width and height of exactly 100px, or
         * a <strong>.TGS</strong> animation with a thumbnail up to 32 kilobytes in size
         * (see <a href="https://core.telegram.org/stickers#animation-requirements"></a><a
         ...
         * href="https://core.telegram.org/stickers#video-requirements"></a><a
         * href="https://core.telegram.org/stickers#video-requirements">https://core.telegram.org/stickers#video-requirements</a>
         * for video sticker technical requirements. Pass a <em>file_id</em> as a String to
         * send a file that already exists on the Telegram servers, pass an HTTP URL as a
         * String for Telegram to get a file from the Internet, or upload a new one using
         * multipart/form-data. <a
         * href="https://core.telegram.org/bots/api#sending-files">More information on
         * Sending Files </a>. Animated and video sticker set thumbnails can't be uploaded
         * via HTTP URL. If omitted, then the thumbnail is dropped and the first sticker is
