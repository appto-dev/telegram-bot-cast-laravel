...
final class UpgradeGift extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * <code>gift.prepaid_upgrade_star_count > 0</code>, then pass 0, otherwise, the <em>can_transfer_stars</em>
         * business bot right is required and <code>gift.upgrade_star_count</code> must be passed.
         */
