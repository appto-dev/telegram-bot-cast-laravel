...
final class CreateInvoiceLink extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        public array $prices,
        /**
         * The number of seconds the subscription will be active for before the next payment. The currency must be set to "XTR"
         * (Telegram Stars) if the parameter is used. Currently, it must always be 2592000 (30 days) if specified. Any number of
         * subscriptions can be active for a given bot at the same time, including multiple concurrent subscriptions from the same
