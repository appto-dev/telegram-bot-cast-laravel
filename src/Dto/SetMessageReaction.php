...
final class SetMessageReaction extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * A JSON-serialized list of reaction types to set on the message. Currently, as non-premium users, bots can set
         * up to one reaction per message. A custom emoji reaction can be used if it is either already present on the
