...
final class SendAnimation extends Dto implements TelegramBotDto
{
    public function __construct(
        ...
        /**
         * Animation caption (may also be used when resending animation by <em>file_id</em>), 0-1024 characters after
         * entities parsing
         */
        public ?string $caption,
        /**
         * Mode for parsing entities in the animation caption. See <a href="#formatting-options">formatting options</a>
         * for more details.
         */
