 ...
 * returned.
 */
final class SendPhoto extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * photo must be at most 10 MB in size. The photo's width and height must not exceed 10000 in total. Width and height ratio
         * must be at most 20. <a href="#sending-files">More information on Sending Files </a>
         */
        ...
        /**
         * Mode for parsing entities in the photo caption. See <a href="#formatting-options">formatting options</a> for more
         * details.
         */
