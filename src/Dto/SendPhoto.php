...
final class SendPhoto extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * 10000 in total. Width and height ratio must be at most 20. <a href="#sending-files">More information on
         * Sending Files </a>
         */
        public InputFile|string $photo,
        /**
         * Photo caption (may also be used when resending photos by <em>file_id</em>), 0-1024 characters after entities
         * parsing
         */
        public ?string $caption,
        /**
         * Mode for parsing entities in the photo caption. See <a href="#formatting-options">formatting options</a> for
         * more details.
         */
