...
final class SendVoice extends Dto implements TelegramBotDto
{
    public function __construct(
         ...
         * HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data. <a
        ...
        /**
         * Mode for parsing entities in the voice message caption. See <a href="#formatting-options">formatting options</a> for
         * more details.
         */
