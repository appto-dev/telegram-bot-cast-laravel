...
final class InlineQuery extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * Type of the chat from which the inline query was sent. Can be either "sender" for a private chat with the inline query
         * sender, "private", "group", "supergroup", or "channel". The chat type should be always known for requests sent from
