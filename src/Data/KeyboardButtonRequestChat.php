 ...
 * chat if appropriate. <a href="https://core.telegram.org/bots/features#chat-and-user-selection">More about
 * requesting chats </a>.
 */
final class KeyboardButtonRequestChat extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * A JSON-serialized object listing the required administrator rights of the user in the chat. The rights must be
         * a superset of bot_administrator_rights. If not specified, no additional restrictions are applied.
         */
        public ?ChatAdministratorRights $user_administrator_rights,
        /**
         * A JSON-serialized object listing the required administrator rights of the bot in the chat. The rights must be
         * a subset of user_administrator_rights. If not specified, no additional restrictions are applied.
         */
