...
final class TransactionPartnerUser extends Data implements TelegramBotData, TransactionPartner
{
    public function __construct(
         ...
         * for payments for paid media, "gift_purchase" for gifts sent by the bot, "premium_purchase" for Telegram
         * Premium subscriptions gifted by the bot, "business_account_transfer" for direct transfers from managed
         * business accounts
         */
        ...
        public ?Gift $gift,
        /**
         * Number of months the gifted Telegram Premium subscription will be active for; for "premium_purchase"
         * transactions only
         */
