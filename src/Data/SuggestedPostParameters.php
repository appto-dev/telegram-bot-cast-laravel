...
final class SuggestedPostParameters extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * Proposed send date of the post. If specified, then the date must be between 300 second and 2678400 seconds (30
         * days) in the future. If the field is omitted, then the post can be published at any time within 30 days at the
