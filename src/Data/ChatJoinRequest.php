...
final class ChatJoinRequest extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * Identifier of the join request query; for bots assigned to process join request only. If present, then the bot
         * must call sendChatJoinRequestWebApp or directly call answerChatJoinRequestQuery within 10 seconds.
         */
