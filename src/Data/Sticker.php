 ...
 */
final class Sticker extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * Type of the sticker, currently one of "regular", "mask", "custom_emoji". The type of the sticker is independent from its
