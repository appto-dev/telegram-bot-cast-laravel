...
final class Update extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * New version of a channel post that is known to the bot and was edited. This update may at times be triggered
         ...
         * must explicitly specify "message_reaction_count" in the list of allowed_updates to receive these updates. The
