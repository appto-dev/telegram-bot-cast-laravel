...
/**
 * This <a href="https://core.telegram.org/bots/api#available-types">object</a> represents an incoming update.At most one
...
final class Update extends Data implements TelegramBotData
{
    public function __construct(
        /**
         * The update's unique identifier. Update identifiers start from a certain positive number and increase sequentially. This
         * identifier becomes especially handy if you're using webhooks, since it allows you to ignore repeated updates or to
        ...
        /**
         * New version of a message that is known to the bot and was edited. This update may at times be triggered by changes to
        ...
        /**
         * New version of a channel post that is known to the bot and was edited. This update may at times be triggered by changes
         ...
         * "message_reaction" in the list of allowed_updates to receive these updates. The update isn't received for reactions set
         * by bots.
         */
         ...
         * explicitly specify "message_reaction_count" in the list of allowed_updates to receive these updates. The updates are
        ...
        /**
         * The result of an inline query that was chosen by a user and sent to their chat partner. Please see our documentation on
         * the feedback collecting for details on how to enable these updates for your bot.
         */
