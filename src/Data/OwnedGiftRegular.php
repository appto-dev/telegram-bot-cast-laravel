...
final class OwnedGiftRegular extends Data implements TelegramBotData, OwnedGift
{
    public function __construct(
        ...
        /**
         * Number of Telegram Stars that can be claimed by the receiver instead of the gift; omitted if the gift cannot be
         * converted to Telegram Stars; for gifts received on behalf of business accounts only
         */
        ...
        /**
         * True, if the gift's upgrade was purchased after the gift was sent; for gifts received on behalf of business accounts
         * only
         */
