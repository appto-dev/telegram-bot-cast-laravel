 ...
 */
final class InputMediaVideo extends Data implements TelegramBotData, InputMedia
{
    public function __construct(
         ...
         * using multipart/form-data under <file_attach_name> name. More information on
         * Sending Files
         */
