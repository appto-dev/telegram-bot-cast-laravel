...
final class InlineKeyboardButton extends Data implements TelegramBotData
{
    public function __construct(
        ...
        /**
         * An HTTPS URL used to automatically authorize the user. Can be used as a replacement for the Telegram Login
         * Widget.
         */
        ...
        /**
         * Specify True, to send a Pay button. Substrings "" and "XTR" in the buttons's text will be replaced with a
         * Telegram Star icon.NOTE: This type of button must always be the first button in the first row and can only be
