...
final class InputStoryContentPhoto extends Data implements TelegramBotData, InputStoryContent
{
    public function __construct(
        ...
        public string $type,
        /**
         * The photo to post as a story. The photo must be of the size 1080x1920 and must not exceed 10 MB. The photo
         * can't be reused and can only be uploaded as a new file, so you can pass "attach://<file_attach_name>" if the
