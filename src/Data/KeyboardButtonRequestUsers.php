 ...
 * with the bot when the corresponding button is pressed. <a
...
final class KeyboardButtonRequestUsers extends Data implements TelegramBotData
{
    public function __construct(
        /**
         * Signed 32-bit identifier of the request that will be received back in the UsersShared object. Must be unique within the
         * message
         */
        public int $request_id,
        /**
         * Pass True to request bots, pass False to request regular users. If not specified, no additional restrictions are
         * applied.
         */
