 ...
 */
final class SendSticker extends Data implements TelegramBotData
{
    public function __construct(
         ...
         * Sending Files </a>. Video and animated stickers can't be sent via an HTTP URL.
         */
         ...
         * keyboard</a>, <a href="https://core.telegram.org/bots/features#keyboards">custom
         * reply keyboard</a>, instructions to remove a reply keyboard or to force a reply
         * from the user
         */
