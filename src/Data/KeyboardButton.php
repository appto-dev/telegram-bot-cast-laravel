 ...
 * <em>icon_custom_emoji_id</em>, and <em>style</em> must be used to specify the type of the button. For simple
 * text buttons, <em>String</em> can be used instead of this object to specify the button text.
 */
final class KeyboardButton extends Data implements TelegramBotData
{
    public function __construct(
        ...
        public string $text,
        /**
         * Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that
         ...
         * sent to the bot in a "users_shared" service message. Available in private chats only.
         */
        ...
        /**
         * If specified, pressing the button will ask the user to create and share a bot that will be managed by the
         * current bot. Available for bots that enabled management of other bots in the @BotFather Mini App. Available in
         * private chats only.
         */
