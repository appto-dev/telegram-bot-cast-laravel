...
use Appto\TelegramBot\Data\CallbackGame;
...
use Appto\TelegramBot\Data\CopyTextButton;
...
use Appto\TelegramBot\Data\InlineKeyboardButton;
...
use Appto\TelegramBot\Data\InputChecklistTask;
...
use Appto\TelegramBot\Data\LoginUrl;
...
use Appto\TelegramBot\Data\StoryAreaPosition;
use Appto\TelegramBot\Data\SuggestedPostParameters;
use Appto\TelegramBot\Data\SuggestedPostPrice;
use Appto\TelegramBot\Data\SwitchInlineQueryChosenChat;
...
use Appto\TelegramBot\Data\WebAppInfo;
...
interface TelegramBotInterface
{
     ...
     * href="https://en.wikipedia.org/wiki/Push_technology#Long_polling">wiki</a>). Returns an Array of <a
     * href="https://core.telegram.org/bots/api#update">Update</a> objects.
     *
     * @param GetUpdates|array{offset?: int, limit?: int, timeout?: int, allowed_updates?: array<string>} $dto
     * @return Update[]
     */
     ...
     *
     * @param SetWebhook|array{url: string, certificate?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}, ip_address?: string, max_connections?: int, allowed_updates?: array<string>, drop_pending_updates?: bool, secret_token?: string} $dto
     * @return true
     */
     ...
     *
     * @param DeleteWebhook|array{drop_pending_updates?: bool} $dto
     * @return true
     */
     ...
     *
     * @param SendMessage|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, text: string, parse_mode?: string, entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, link_preview_options?: LinkPreviewOptions|array{is_disabled?: bool, url?: string, prefer_small_media?: bool, prefer_large_media?: bool, show_above_text?: bool, _additional: array, _dataContext?: DataContext|array}, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     *
     * @param ForwardMessage|array{chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, from_chat_id: int|string, video_start_timestamp?: int, disable_notification?: bool, protect_content?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, message_id: int} $dto
     * @return Message
     */
     ...
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param SendPhoto|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, photo: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, show_caption_above_media?: bool, has_spoiler?: bool, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     * method instead.
     *
     * @param SendAudio|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, audio: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, duration?: int, performer?: string, title?: string, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     *
     * @param SendDocument|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, document: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, disable_content_type_detection?: bool, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     * of up to 50 MB in size, this limit may be changed in the future.
     *
     * @param SendVideo|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, video: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, duration?: int, width?: int, height?: int, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, cover?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, start_timestamp?: int, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, show_caption_above_media?: bool, has_spoiler?: bool, supports_streaming?: bool, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     *
     * @param SendAnimation|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, animation: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, duration?: int, width?: int, height?: int, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, show_caption_above_media?: bool, has_spoiler?: bool, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     *
     * @param SendVideoNote|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, video_note: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, duration?: int, length?: int, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     *
     * @param SendMediaGroup|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, media: InputMediaAudio|array{type: string, media: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string|null, caption?: string, parse_mode?: string, caption_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, duration?: int, performer?: string, title?: string, _additional: array, _dataContext?: DataContext|array}|InputMediaDocument|array{type: string, media: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string|null, caption?: string, parse_mode?: string, caption_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, disable_content_type_detection?: bool, _additional: array, _dataContext?: DataContext|array}|InputMediaPhoto|array{type: string, media: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, caption?: string, parse_mode?: string, caption_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, show_caption_above_media?: bool, has_spoiler?: bool, _additional: array, _dataContext?: DataContext|array}|InputMediaVideo|array{type: string, media: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string|null, cover?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string|null, start_timestamp?: int, caption?: string, parse_mode?: string, caption_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, show_caption_above_media?: bool, width?: int, height?: int, duration?: int, supports_streaming?: bool, has_spoiler?: bool, _additional: array, _dataContext?: DataContext|array}, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return Message[]
     */
     ...
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param SendLocation|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, latitude: float, longitude: float, horizontal_accuracy?: float, live_period?: int, heading?: int, proximity_alert_radius?: int, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param SendVenue|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, latitude: float, longitude: float, title: string, address: string, foursquare_id?: string, foursquare_type?: string, google_place_id?: string, google_place_type?: string, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param SendContact|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, phone_number: string, first_name: string, last_name?: string, vcard?: string, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param SendChecklist|array{business_connection_id: string, chat_id: int, checklist: InputChecklist|array{title: string, parse_mode?: string, title_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, tasks: InputChecklistTask|array{id: int, text: string, parse_mode?: string, text_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}, others_can_add_tasks?: bool, others_can_mark_tasks_as_done?: bool, _additional: array, _dataContext?: DataContext|array}, disable_notification?: bool, protect_content?: bool, message_effect_id?: string, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return Message
     */
    public function sendChecklist(SendChecklist|array $dto): Message;

    /**
     * Use this method to send an animated emoji that will display a random value. On success, the sent <a
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param SendDice|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, emoji?: string, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     * bots with forum topic mode enabled. Returns <em>True</em> on success.
     *
     * @param SendMessageDraft|array{chat_id: int, message_thread_id?: int, draft_id: int, text: string, parse_mode?: string, entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>} $dto
     * @return true
     */
     ...
     *
     * @param GetUserProfilePhotos|array{user_id: int, offset?: int, limit?: int} $dto
     ...
     *
     * @param GetUserProfileAudios|array{user_id: int, offset?: int, limit?: int} $dto
     ...
     * Returns <em>True</em> on success.
     *
     * @param SetChatPhoto|array{chat_id: int|string, photo: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true
     */
     ...
     *
     * @param LeaveChat|array{chat_id: int|string} $dto
     * @return true
     */
     ...
     * href="https://core.telegram.org/bots/api#chatfullinfo">ChatFullInfo</a> object on success.
     *
     * @param GetChat|array{chat_id: int|string} $dto
     * @return ChatFullInfo
     */
     ...
     *
     * @param GetChatMemberCount|array{chat_id: int|string} $dto
     * @return int
     */
     ...
     *
     * @param GetBusinessConnection|array{business_connection_id: string} $dto
     ...
     * Returns <em>True</em> on success.
     *
     * @param SetMyCommands|array{commands: BotCommand[]|array<array{command: string, description: string, _additional: array, _dataContext?: DataContext|array}>, scope?: BotCommandScope|array, language_code?: string} $dto
     * @return true
     */
     ...
     *
     * @param SetMyName|array{name?: string, language_code?: string} $dto
     * @return true
     */
    public function setMyName(SetMyName|array $dto): true;

    /**
     * Use this method to get the current bot name for the given user language. Returns <a
     * href="https://core.telegram.org/bots/api#botname">BotName</a> on success.
     *
     * @param GetMyName|array{language_code?: string} $dto
     * @return BotName
     */
     ...
     *
     * @param GetMyDescription|array{language_code?: string} $dto
     ...
     *
     * @param GetMyShortDescription|array{language_code?: string} $dto
     ...
     *
     * @param SetMyProfilePhoto|array{photo: InputProfilePhoto|array} $dto
     * @return true
     */
     ...
     *
     * @param GetMyDefaultAdministratorRights|array{for_channels?: bool} $dto
     ...
     *
     * @param SetBusinessAccountGiftSettings|array{business_connection_id: string, show_gift_button: bool, accepted_gift_types: AcceptedGiftTypes|array{unlimited_gifts: bool, limited_gifts: bool, unique_gifts: bool, premium_subscription: bool, gifts_from_channels: bool, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true
     */
     ...
     *
     * @param TransferBusinessAccountStars|array{business_connection_id: string, star_count: int} $dto
     * @return true
     */
     ...
     * href="https://core.telegram.org/bots/api#ownedgifts">OwnedGifts</a> on success.
     *
     * @param GetUserGifts|array{user_id: int, exclude_unlimited?: bool, exclude_limited_upgradable?: bool, exclude_limited_non_upgradable?: bool, exclude_from_blockchain?: bool, exclude_unique?: bool, sort_by_price?: bool, offset?: string, limit?: int} $dto
     * @return OwnedGifts
     */
     ...
     *
     * @param PostStory|array{business_connection_id: string, content: InputStoryContent|array, active_period: int, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, areas?: StoryArea[]|array<array{position: StoryAreaPosition|array{x_percentage: float, y_percentage: float, width_percentage: float, height_percentage: float, rotation_angle: float, corner_radius_percentage: float, _additional: array, _dataContext?: DataContext|array}, type: StoryAreaType|array, _additional: array, _dataContext?: DataContext|array}>, post_to_chat_page?: bool, protect_content?: bool} $dto
     * @return Story
     */
     ...
     * href="https://core.telegram.org/bots/api#story">Story</a> on success.
     *
     * @param EditStory|array{business_connection_id: string, story_id: int, content: InputStoryContent|array, caption?: string, parse_mode?: string, caption_entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, areas?: StoryArea[]|array<array{position: StoryAreaPosition|array{x_percentage: float, y_percentage: float, width_percentage: float, height_percentage: float, rotation_angle: float, corner_radius_percentage: float, _additional: array, _dataContext?: DataContext|array}, type: StoryAreaType|array, _additional: array, _dataContext?: DataContext|array}>} $dto
     * @return Story
     */
     ...
     *
     * @param DeleteStory|array{business_connection_id: string, story_id: int} $dto
     * @return true
     */
     ...
     *
     * @param EditMessageText|array{business_connection_id?: string, chat_id?: int|string, message_id?: int, inline_message_id?: string, text: string, parse_mode?: string, entities?: MessageEntity[]|array<array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}>, link_preview_options?: LinkPreviewOptions|array{is_disabled?: bool, url?: string, prefer_small_media?: bool, prefer_large_media?: bool, show_above_text?: bool, _additional: array, _dataContext?: DataContext|array}, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true|Message
     */
     ...
     * only be edited within 48 hours from the time they were sent.
     *
     * @param EditMessageMedia|array{business_connection_id?: string, chat_id?: int|string, message_id?: int, inline_message_id?: string, media: InputMedia|array, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true|Message
     */
     ...
     * returned.
     *
     * @param StopMessageLiveLocation|array{business_connection_id?: string, chat_id?: int|string, message_id?: int, inline_message_id?: string, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true|Message
     */
     ...
     * href="https://core.telegram.org/bots/api#message">Message</a> is returned.
     *
     * @param EditMessageChecklist|array{business_connection_id: string, chat_id: int, message_id: int, checklist: InputChecklist|array{title: string, parse_mode?: string, title_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, tasks: InputChecklistTask|array{id: int, text: string, parse_mode?: string, text_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}, others_can_add_tasks?: bool, others_can_mark_tasks_as_done?: bool, _additional: array, _dataContext?: DataContext|array}, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return Message
     */
     ...
     *
     * @param EditMessageReplyMarkup|array{business_connection_id?: string, chat_id?: int|string, message_id?: int, inline_message_id?: string, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true|Message
     */
    public function editMessageReplyMarkup(EditMessageReplyMarkup|array $dto): true|Message;

    /**
     * Use this method to stop a poll which was sent by the bot. On success, the stopped <a
     * href="https://core.telegram.org/bots/api#poll">Poll</a> is returned.
     *
     * @param StopPoll|array{business_connection_id?: string, chat_id: int|string, message_id: int, reply_markup?: InlineKeyboardMarkup|array{inline_keyboard: InlineKeyboardButton|array{text: string, icon_custom_emoji_id?: string, style?: string, url?: string, callback_data?: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, login_url?: LoginUrl|array{url: string, forward_text?: string, bot_username?: string, request_write_access?: bool, _additional: array, _dataContext?: DataContext|array}, switch_inline_query?: string, switch_inline_query_current_chat?: string, switch_inline_query_chosen_chat?: SwitchInlineQueryChosenChat|array{query?: string, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool, _additional: array, _dataContext?: DataContext|array}, copy_text?: CopyTextButton|array{text: string, _additional: array, _dataContext?: DataContext|array}, callback_game?: CallbackGame|array{_additional: array, _dataContext?: DataContext|array}, pay?: bool, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return Poll
     */
     ...
     *
     * @param SendSticker|array{business_connection_id?: string, chat_id: int|string, message_thread_id?: int, direct_messages_topic_id?: int, sticker: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, emoji?: string, disable_notification?: bool, protect_content?: bool, allow_paid_broadcast?: bool, message_effect_id?: string, suggested_post_parameters?: SuggestedPostParameters|array{price?: SuggestedPostPrice|array{currency: string, amount: int, _additional: array, _dataContext?: DataContext|array}, send_date?: int, _additional: array, _dataContext?: DataContext|array}, reply_parameters?: ReplyParameters|array{message_id: int, chat_id?: string|int|null, allow_sending_without_reply?: bool, quote?: string, quote_parse_mode?: string, quote_entities?: MessageEntity|array{type: string, offset: int, length: int, url?: string, user?: User|array{id: int, is_bot: bool, first_name: string, last_name?: string, username?: string, language_code?: string, is_premium?: true, added_to_attachment_menu?: true, can_join_groups?: bool, can_read_all_group_messages?: bool, supports_inline_queries?: bool, can_connect_to_business?: bool, has_main_web_app?: bool, has_topics_enabled?: bool, allows_users_to_create_topics?: bool, _additional: array, _dataContext?: DataContext|array}, language?: string, custom_emoji_id?: string, _additional: array, _dataContext?: DataContext|array}, quote_position?: int, checklist_task_id?: int, _additional: array, _dataContext?: DataContext|array}, reply_markup?: ReplyMarkup|array} $dto
     * @return Message
     */
     ...
     *
     * @param GetStickerSet|array{name: string} $dto
     * @return StickerSet
     */
     ...
     *
     * @param GetCustomEmojiStickers|array{custom_emoji_ids: array<string>} $dto
     * @return Sticker[]
     */
     ...
     * success.
     *
     * @param UploadStickerFile|array{user_id: int, sticker: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}, sticker_format: string} $dto
     * @return File
     */
     ...
     *
     * @param CreateNewStickerSet|array{user_id: int, name: string, title: string, stickers: InputSticker[]|array<array{sticker: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, format: string, emoji_list: array, mask_position?: MaskPosition|array{point: string, x_shift: float, y_shift: float, scale: float, _additional: array, _dataContext?: DataContext|array}, keywords?: array, _additional: array, _dataContext?: DataContext|array}>, sticker_type?: string, needs_repainting?: bool} $dto
     * @return true
     */
     ...
     *
     * @param AddStickerToSet|array{user_id: int, name: string, sticker: InputSticker|array{sticker: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, format: string, emoji_list: array, mask_position?: MaskPosition|array{point: string, x_shift: float, y_shift: float, scale: float, _additional: array, _dataContext?: DataContext|array}, keywords?: array, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true
     */
     ...
     *
     * @param DeleteStickerFromSet|array{sticker: string} $dto
     * @return true
     */
     ...
     * <em>True</em> on success.
     *
     * @param ReplaceStickerInSet|array{user_id: int, name: string, old_sticker: string, sticker: InputSticker|array{sticker: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, format: string, emoji_list: array, mask_position?: MaskPosition|array{point: string, x_shift: float, y_shift: float, scale: float, _additional: array, _dataContext?: DataContext|array}, keywords?: array, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true
     */
     ...
     * success.
     *
     * @param SetStickerMaskPosition|array{sticker: string, mask_position?: MaskPosition|array{point: string, x_shift: float, y_shift: float, scale: float, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true
     */
     ...
     *
     * @param SetStickerSetTitle|array{name: string, title: string} $dto
     * @return true
     */
     ...
     *
     * @param SetStickerSetThumbnail|array{name: string, user_id: int, thumbnail?: InputFile|array{attach: string, _additional: array, _dataContext?: DataContext|array}|string, format: string} $dto
     * @return true
     */
     ...
     *
     * @param SetCustomEmojiStickerSetThumbnail|array{name: string, custom_emoji_id?: string} $dto
     * @return true
     */
     ...
     *
     * @param DeleteStickerSet|array{name: string} $dto
     * @return true
     */
     ...
     *
     * @param AnswerInlineQuery|array{inline_query_id: string, results: InlineQueryResult, cache_time?: int, is_personal?: bool, next_offset?: string, button?: InlineQueryResultsButton|array{text: string, web_app?: WebAppInfo|array{url: string, _additional: array, _dataContext?: DataContext|array}, start_parameter?: string, _additional: array, _dataContext?: DataContext|array}} $dto
     * @return true
     */
     ...
     *
     * @param SavePreparedInlineMessage|array{user_id: int, result: InlineQueryResult|array, allow_user_chats?: bool, allow_bot_chats?: bool, allow_group_chats?: bool, allow_channel_chats?: bool} $dto
     ...
     * <em>True</em> is returned.
     *
     * @param AnswerShippingQuery|array{shipping_query_id: string, ok: bool, shipping_options?: ShippingOption[]|array<array{id: string, title: string, prices: LabeledPrice|array{label: string, amount: int, _additional: array, _dataContext?: DataContext|array}, _additional: array, _dataContext?: DataContext|array}>, error_message?: string} $dto
     * @return true
     */
     ...
     *
     * @param GetStarTransactions|array{offset?: int, limit?: int} $dto
